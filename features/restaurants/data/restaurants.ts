...
export const nearbyRestaurants: RestaurantSummary[] = [
  ...
  },
  {
    id: "taizu",
    name: "טאיזו",
    cuisine: "מטבח יפני מודרני",
    address: "רח׳ קינג ג׳ורג׳ 23, תל אביב",
    distanceKm: 0.6,
  ...
  },
  {
    ...
    name: "קפה נור",
    cuisine: "קפה ומאפים",
    address: "רח׳ דיזנגוף 150, תל אביב",
    distanceKm: 0.8,
  ...
  },
  {
    id: "ola",
    name: "אולה",
    cuisine: "מטבח בריא ומודרני",
    address: "רח׳ יהודה הלוי 97, תל אביב",
    distanceKm: 1.2,
